	...
	html,body{
		...
		100% {background-color: black;}
		 ...
		 .circle {
			...
			body
				{
						background-image:url("https://photos.smugmug.com/Australia/Queensland/Heron-Island/i-NCrJxZv/0/L/2012-10-31%2520at%252007-10-47-L.jpg");
...
<H1 class="class2" style="opacity:0.8;">Region-(Australia & Oceania)-Reef</H1>
<p id="g" >
<center>
<div style="border-radius:15%;background-color:#98315E;width:90%;padding:3%;background: rgb(152, 49, 94);background: rgba(152, 49, 94, 0.6);"><img src="https://pbs.twimg.com/media/CussFqVWYAEygcJ.jpg" alt="Green sea turtle" style="width:19.2%;height:relative;"><img src="https://s-media-cache-ak0.pinimg.com/564x/f2/1a/c9/f21ac921e1b5f91219c551fd5bbba8e4.jpg" alt="Green sea turtle" style="width:19.2%;height:relative;"><img src="http://cdn.tourismontheedge.com/wp-content/uploads/2010/06/1423816665_5caa5d1a8e2.jpg" alt="Green sea turtle" style="width:19.2%;height:relative;"><img src="https://rummahan.files.wordpress.com/2014/10/great_barrier_reef_coral_fish-2.jpg" alt="Green sea turtle" style="width:19.2%;height:relative;"><img src="http://totalsolareclipses.com/sites/default/files/styles/colorbox/public/Australia_Queensland_Great_barrier_reef_006.jpg" alt="Green sea turtle" style="width:19.2%;height:relative;">
</div>
</center>
</p>
...
<td>
<H1 class="class6" style="opacity:0.8;">
Great Barrier Reef
</H1>
</td>
<p style="opacity:0.7;">
<!--<pre>-->
<div style="background-color:violet;padding:5px;border-radius:5px;overflow:hidden;"><div style="background-color:orange;padding:5px;border-radius:5px;overflow:hidden"></div><textarea maxlength="50" rows="7" cols="50" style="position:relative;max-width:100%;color:red;background-color:#28CAA3;font-family:cooper;font-weight:bold;box-shadow: 0 0 10px 10px pink; ">
Great Barrier Reef

The Great Barrier Reef is a site of remarkable variety and beauty on the north-east coast of Australia. It contains the world’s largest collection of coral reefs, with 400 types of coral, 1,500 species of fish and 4,000 types of mollusc. It also holds great scientific interest as the habitat of species such as the dugong (‘sea cow’) and the large green turtle, which are threatened with extinction.

UNESCO Article as List
...
</textarea> <img src="http://reefcruise.com.au/files/2013/08/Great-Barrier-Reef-Cairns.jpg" style="height:23%;width:relative"> <img src="http://travelmemo.com/wp-content/uploads/2010/12/Lionfish-Walter-Schaerer-Great-Barrier-Reef.jpg" style="height:23%;width:relative"> <img src="http://www.designreisen.de/fileadmin/designreisen-relaunch/Suedpazifik/Australien/Great_Barrier_Reef_-_One_Only_Hayman_Island/Meer.jpg" style="height:23%;width:relative"> <img src="https://www.cairnsholidayspecialists.com.au/shared_resources/media/vibrant-colours-of-coral-on-the-15450_1024x768.jpg" style="height:23%;width:relative"> <div style="background-color:orange;padding:5px;border-radius:5px;overflow:hidden"></div></div>
