	...
	html,body{
		...
		100% {background-color: black;}
		 ...
		 .circle {
			...
			body
				{
						background-image:url("https://s-media-cache-ak0.pinimg.com/736x/5d/aa/bd/5daabdccbf33d0a06e5dacd978bf23d8.jpg");
...
<H1 class="class3" style="opacity:0.8;">Region-(Southern Africa)-Desert</H1>
<p id="g" >
<center>
<div style="border-radius:15%;background-color:red;width:90%;padding:3%;background: rgb(255, 100, 0);background: rgba(255, 100, 0, 0.5);"><img src="http://backwallpapers.com/wp-content/uploads/2016/08/Namib-Desert-HQ-Image-New-1224.jpg" alt="Green sea turtle" style="width:19.2%;height:relative;"><img src="https://s-media-cache-ak0.pinimg.com/564x/a6/21/fa/a621fa76e9001b97f1bd8760aecafbfe.jpg" alt="Green sea turtle" style="width:19.2%;height:relative;"><img src="http://infoshutter.com/wp-content/uploads/2015/06/Desert-and-Ocean-10.jpg" alt="Green sea turtle" style="width:19.2%;height:relative;"><img src="http://www.redfernnaturalhistory.com/wp-content/uploads/2016/09/Namibia-Trip-1.png" alt="Green sea turtle" style="width:19.2%;height:relative;"><img src="https://s-media-cache-ak0.pinimg.com/564x/1a/dc/69/1adc692badf6869a4abee8c5740c8a7f.jpg" alt="Green sea turtle" style="width:19.2%;height:relative;">
</div>
</center>
</p>
...
<p style="opacity:0.7;">
<!--<pre>-->
<div style="background-color:purple;padding:5px;border-radius:5px;overflow:hidden;"><div style="background-color:orange;padding:5px;border-radius:5px;overflow:hidden"></div><textarea maxlength="50" rows="7" cols="50" style="position:relative;max-width:100%;color:white;background-color:orange;font-family:cooper;font-weight:bold;box-shadow: 0 0 10px 10px pink; ">
...
</textarea> <img src="http://2.bp.blogspot.com/-3dZIL61h2kE/VfYJ3DYpbVI/AAAAAAAABFE/kEkwwKxLoN8/s1600/Desert%2B%252810%2529.jpg" style="height:23%;width:relative"> <img src="http://originaltravel.assets.d3r.com/images/gallery/257665-skeleton-coast-2.jpg" style="height:23%;width:relative"> <img src="http://afrika-raj.ru/images/zhizn-v-pustine-namib1.jpg" style="height:23%;width:relative"> <img src="http://images.meltour.com/image/default//aventure-caprivi-zambeze-namibie-sossusvlei.jpg" style="height:23%;width:relative"> <div style="background-color:orange;padding:5px;border-radius:5px;overflow:hidden"></div></div>
...
<H5 align="right">
<a href="https://en.wikipedia.org/wiki/Namib_Desert">
