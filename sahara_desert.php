	...
	html,body{
		...
		100% {background-color: black;}
		 ...
		 .circle {
			...
			body
				{
						background-image:url("http://atalantatravel.ru/images/photoes/tun5.jpg");
...
<H1 class="class5" style="opacity:0.8;color:red;">Region-(Northern Africa)-Desert</H1>
<p id="g" >
<center>
<div style="border-radius:15%;background-color:purple;width:90%;padding:3%;background: rgb(153, 0, 153);background: rgba(153, 0, 153, 0.6);"><img src="http://travelercorner.com/wp-content/uploads/2016/03/sahara-desert-algeria-600x450.jpg" alt="Green sea turtle" style="width:19.2%;height:relative;"><img src="http://www.place-des-vacances.com/assets/images/dossier/59-1455620626.jpg" alt="Green sea turtle" style="width:19.2%;height:relative;"><img src="http://ichef.bbci.co.uk/wwfeatures/wm/live/1280_640/images/live/p0/14/pr/p014prww.jpg" alt="Green sea turtle" style="width:19.2%;height:relative;"><img src="http://evodevi.bursabi.com/wp-content/uploads/2015/08/sahra-%C3%A7%C3%B6l%C3%BC-iklim-%C3%B6zellikleri.jpg" alt="Green" alt="Green sea turtle" style="width:19.2%;height:relative;"><img src="http://travelercorner.com/wp-content/uploads/2016/03/Camel-Riding-at-sahara-desert-africa-600x450.jpg" alt="Green sea turtle" style="width:19.2%;height:relative;">
</div>
</center>
</p>
...
<td>
<H1 class="class6" style="opacity:0.8;color:orange;">
Sahara Desert
</H1>
</td>
<p style="opacity:0.7;">
<!--<pre>-->
<div style="background-color:#FDDD54;padding:5px;border-radius:5px;overflow:hidden;"><div style="background-color:orange;padding:5px;border-radius:5px;overflow:hidden"></div><textarea maxlength="50" rows="7" cols="50" style="position:relative;max-width:100%;color:#60E63D;background-color:#DB614D;font-family:cooper;font-weight:bold;box-shadow: 0 0 10px 10px pink; ">
The Sahara Desert
...
</textarea> <img src="http://justfunfacts.com/wp-content/uploads/2016/03/sahara-desert-oasis.jpg" style="height:23%;width:relative"> <img src="http://travelercorner.com/wp-content/uploads/2016/03/Sahara-Desert-trees-600x338.jpg" style="height:23%;width:relative"> <img src="http://2.bp.blogspot.com/-6fNyMgaC_co/UQa5o9Dx8sI/AAAAAAAAMJg/CgRtk4iQiqw/s1600/Desert+Animals+(2).jpg" style="height:23%;width:relative"> <img src="http://kids.nationalgeographic.com/content/dam/kids/photos/animals/Mammals/A-G/fennec-fox-hole.jpg.adapt.945.1.jpg" style="height:23%;width:relative"> <div style="background-color:orange;padding:5px;border-radius:5px;overflow:hidden"></div></div>
...
<H5 align="right">
<a href="https://en.wikipedia.org/wiki/Sahara">
